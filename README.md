...
│   │   ├── [ShortCall.hpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/include/models/ShortCall.hpp)\
│   │   └── [Portfolio.hpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/include/models/Portfolio.hpp)\
│   ├── storage/\
...
│   ├── optimization/\
│   │   └── [MeanVarianceOptimizer.hpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/include/optimization/MeanVarianceOptimizer.hpp)\
│   ├── simulation/\
...
│   ├── models/\
│   │   ├── [Option.cpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/src/models/Option.cpp)\
│   │   ├── [ShortPut.cpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/src/models/ShortPut.cpp)\
│   │   ├── [LongPut.cpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/src/models/LongPut.cpp)\
...
│   │   ├── [Battery.cpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/src/storage/Battery.cpp)\
│   │   └── [P2G.cpp](https://github.com/manuelmusngi/options-portfolio-risk-hedging-natural-gas/blob/main/src/storage/P2G.cpp)\
│   ├── optimization/\
